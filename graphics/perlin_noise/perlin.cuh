...
#include "teg_perlin_thresholded.h"
#include "teg_perlin_threshold_deriv.h"
...
__global__
void perlin_threshold_kernel(int* qids,
                            int* pids,
                            int num_jobs,
                            Grid* grid,
                            Color* pcolor,
                            ...
                            int w, int h)
{
    ...
    auto outvals = teg_perlin_thresholded(
        vec00.x, vec00.y,
        vec10.x, vec10.y,
        vec01.x, vec01.y,
        vec11.x, vec11.y,
...
__global__
void perlin_threshold_deriv(int* qids,
                            int* pids,
                            int num_jobs,
                            Image* target_image,
                            Grid* grid,
                            ...
                            int w, int h)
{
    ...
    // Run generated teg function.
    auto outvals = teg_perlin_threshold_deriv(
        vec00.x, vec00.y,
        vec10.x, vec10.y,
        vec01.x, vec01.y,
        vec11.x, vec11.y,
    ...
    atomicAdd(d_threshold, outvals[14]);
}
